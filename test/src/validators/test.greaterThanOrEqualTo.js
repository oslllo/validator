...
describe("is.greaterThanOrEqualTo", () => {
    //! TRUE
	it(`can tell that 3 is greater than or equal to 2`, () => {
		assert.isTrue(is.greaterThanOrEqualTo(3, 2));
    });
    it(`can tell that 3 is greater than or equal to 3`, () => {
		assert.isTrue(is.greaterThanOrEqualTo(3, 3));
    });
    it(`can tell that abc is greater than or equal to a`, () => {
		assert.isTrue(is.greaterThanOrEqualTo('abc', 'a'));
    });
    it(`can tell that abc is greater than or equal to abc`, () => {
		assert.isTrue(is.greaterThanOrEqualTo('abc', 'abc'));
    });
    //! FALSE
    it(`can tell that 2 is NOT greater than or equal to 3`, () => {
		assert.isFalse(is.greaterThanOrEqualTo(2, 3));
    });
    it(`can tell that a is NOT greater than or equal to abc`, () => {
		assert.isFalse(is.greaterThanOrEqualTo('a', 'abc'));
    });
    it(`can tell that Infinity is NOT greater than or equal to anything`, () => {
		assert.isFalse(is.greaterThanOrEqualTo(Infinity, 0));
    });
    it(`can tell that anything is NOT greater than or equal to Infinity`, () => {
